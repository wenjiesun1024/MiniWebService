...
void SqlConnectionPool::InitPool(string host, string user, string password, string dataBaseName, int port, int maxConn)
{
    ...
    for (int i = 0; i < maxConn; i++)
    {
        ...
        sql = mysql_real_connect(sql, host.c_str(),
